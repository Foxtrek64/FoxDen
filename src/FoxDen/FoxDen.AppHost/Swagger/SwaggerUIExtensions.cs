...
namespace FoxDen.AppHost.Swagger
{
    public static class SwaggerUIExtensions
    {
        ...
        public static IEndpointConventionBuilder MapSwaggerUI(this IEndpointRouteBuilder builder)
        {
            return builder.MapGet("/swagger/{resourceName}/{documentName}", (string resourceName, string documentName) => Results.Content($$"""
    <html>
    <head>
        <meta charset="UTF-8">
